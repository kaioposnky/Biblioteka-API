package org.busnake.biblioteka_api.security.middleware;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    public SecurityFilter(TokenService tokenService, UserDetailsRepository userDetailsRepository) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // se tiver um token para processar
        if(token != null){
        ...
        // chamar o proximo filtro, processar proximos requests
        filterChain.doFilter(request, response);
    }

    private String recoverToken(HttpServletRequest httpRequest){
